    ...
    <div class="menu-table">
      <div class="margin-general-table">
        <el-table :data="tableData" class="table" border>
          <el-table-column label="用户ID" prop="cvLgnId" show-overflow-tooltip width="100" align="center" />
          <el-table-column label="用户名" prop="userNm" show-overflow-tooltip width="80" align="center" />
          <el-table-column label="是否在线" prop="onliYn" show-overflow-tooltip width="100" align="center" />
          <el-table-column label="最后登录日时" prop="fnlLoutDttm" show-overflow-tooltip align="center" />
          <el-table-column label="最终登出日时" prop="lastLgnDttm" show-overflow-tooltip align="center" />
        </el-table>
      </div>
...
const getTableData = () => {
  ...
  getUserOnliHList(postData).then(res => {
